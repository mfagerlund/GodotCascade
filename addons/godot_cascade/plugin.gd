...
const CASCADE_SCROLL_SCRIPT := preload("res://addons/godot_cascade/components/cascade_scroll.gd")
...
func _enter_tree() -> void:
	...
	add_custom_type("CascadeScroll", "ScrollContainer", CASCADE_SCROLL_SCRIPT, null)
...
func _exit_tree() -> void:
	...
	remove_custom_type("CascadeScroll")
