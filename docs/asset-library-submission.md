...
This is the copy-ready submission record for the GodotCascade 0.4.0 experimental preview. New community entries are published at the Asset Library's **testing** support level; that level is assigned by the library and is not a field in the public submission form.
...
| Asset version | `0.4.0` |
| Download URL | `https://github.com/mfagerlund/GodotCascade/releases/download/v0.4.0/godot-cascade-0.4.0.zip` |
...
- [x] `plugin.cfg` identifies version 0.4.0 and the release ZIP contains the complete addon directory.
