...
Continue with the dedicated [binding guide](bindings.md), [current support reference](current-support.md), [style system](style-system.md), [markup/state guide](markup-and-state.md), and [editor tooling](editor-tooling.md). The [parity showcase](showcase/index.html) contains four executable projects with their HTML references, GXML/GCSS source, native scenes, and captures.
